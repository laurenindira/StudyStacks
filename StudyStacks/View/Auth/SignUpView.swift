...
#Preview {
    SignUpView(tempUser: User(id: "", username: "", displayName: "", email: "", creationDate: Date(), providerRef: "", selectedSubjects: [], studyReminderTime: Date(), studentType: "", currentStreak: 0, longestStreak: 0, points: 0, favoriteStackIDs: []))
